...
║  RESPONSIBILITY: اجرای قابلیت Regime در حوزه Weight Adapter
...
"""regime/adaptive/weight_adapter.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای قابلیت Regime در حوزه Weight Adapter.
