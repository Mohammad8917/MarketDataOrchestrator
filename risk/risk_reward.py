...
║  RESPONSIBILITY: اجرای مسئولیت risk_reward در لایه Risk
...
"""
risk/risk_reward.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت risk_reward در لایه Risk.
