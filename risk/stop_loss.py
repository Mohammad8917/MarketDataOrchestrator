...
║  RESPONSIBILITY: اجرای مسئولیت stop_loss در لایه Risk
...
"""
risk/stop_loss.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت stop_loss در لایه Risk.
