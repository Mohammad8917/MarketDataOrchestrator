...
║  RESPONSIBILITY: اجرای مسئولیت exposure در لایه Risk
...
"""
risk/exposure.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت exposure در لایه Risk.
