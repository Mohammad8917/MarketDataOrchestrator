...
║  RESPONSIBILITY: اجرای مسئولیت position_sizing در لایه Risk
...
"""
risk/position_sizing.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت position_sizing در لایه Risk.
