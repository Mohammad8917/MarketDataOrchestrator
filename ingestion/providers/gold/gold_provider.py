"""Implement the gold provider ingestion responsibility at its declared ingestion subsystem boundary.
...
RESPONSIBILITY: Implement the gold provider ingestion responsibility at its declared ingestion subsystem boundary.
