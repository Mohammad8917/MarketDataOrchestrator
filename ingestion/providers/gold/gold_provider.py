"""Gold-specific ingestion provider boundary.

FILE NAME     : ingestion/providers/gold/gold_provider.py
KIT ADDRESS   : github.com/Mohammad8917/MarketDataOrchestrator
VERSION       : 1.0.0
DATE          : 1405/07/02 — 2026-09-24
AUTHOR        : محمد حسن زاده
RESPONSIBILITY: Adapt the configured gold market-data source into the canonical ingestion-provider boundary.
...
OWNS          : Gold-source-specific transport/protocol adaptation and provider-boundary error translation once implemented.
...
# Frozen provider skeleton; gold integration is intentionally deferred.
