"""Implement the binance provider ingestion responsibility at its declared ingestion subsystem boundary.
...
RESPONSIBILITY: Implement the binance provider ingestion responsibility at its declared ingestion subsystem boundary.
