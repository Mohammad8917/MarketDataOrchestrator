...
║  RESPONSIBILITY: تعریف مرز بسته Python در ingestion/providers/crypto
...
"""ingestion/providers/crypto/__init__.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مرز بسته Python در ingestion/providers/crypto.
