"""Implement the market provider ingestion responsibility at its declared ingestion subsystem boundary.

FILE NAME     : ingestion/interfaces/market_provider.py
KIT ADDRESS   : github.com/Mohammad8917/MarketDataOrchestrator
VERSION       : 1.0.0
DATE          : 1405/07/02 — 2026-09-24
AUTHOR        : محمد حسن زاده
RESPONSIBILITY: Implement the market provider ingestion responsibility at its declared ingestion subsystem boundary.
