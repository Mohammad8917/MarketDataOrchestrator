...
║  RESPONSIBILITY: اجرای قابلیت Ingestion در حوزه Market Provider
...
"""ingestion/interfaces/market_provider.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای قابلیت Ingestion در حوزه Market Provider.
