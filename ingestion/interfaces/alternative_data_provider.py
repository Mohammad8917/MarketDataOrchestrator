...
║  LAYER         : ingestion
║  RESPONSIBILITY: Own the alternative_data_provider responsibility within the ingestion layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; provider interfaces and shared contracts.
║  PYTHON        : 3.13+
