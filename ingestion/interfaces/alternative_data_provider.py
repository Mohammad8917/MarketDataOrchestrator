"""Implement the alternative data provider ingestion responsibility at its declared ingestion subsystem boundary.
...
RESPONSIBILITY: Implement the alternative data provider ingestion responsibility at its declared ingestion subsystem boundary.
