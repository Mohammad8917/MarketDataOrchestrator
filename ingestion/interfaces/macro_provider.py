...
║  RESPONSIBILITY: اجرای قابلیت Ingestion در حوزه Macro Provider
...
"""ingestion/interfaces/macro_provider.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای قابلیت Ingestion در حوزه Macro Provider.
