"""Implement the orderbook normalizer ingestion responsibility at its declared ingestion subsystem boundary.
...
RESPONSIBILITY: Implement the orderbook normalizer ingestion responsibility at its declared ingestion subsystem boundary.
