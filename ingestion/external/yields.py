...
║  RESPONSIBILITY: اجرای قابلیت Ingestion در حوزه Yields
...
"""ingestion/external/yields.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای قابلیت Ingestion در حوزه Yields.
