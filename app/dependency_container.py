"""
╔══════════════════════════════════════════════════════════════════════╗
║  FILE NAME     : app/dependency_container.py
║  KIT ADDRESS   : github.com/Mohammad8917/MarketDataOrchestrator
║  VERSION       : 1.0.0
║  DATE          : 1405/07/02 — 2026-09-24
║  AUTHOR        : محمد حسن زاده
║  LAYER         : app
║  RESPONSIBILITY: Own the dependency_container responsibility within the app layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; core/config and lower-layer application contracts.
║  PYTHON        : 3.13+
