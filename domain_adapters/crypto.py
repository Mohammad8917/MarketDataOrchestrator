...
║  RESPONSIBILITY: تطبیق تفاوت‌های Provider با Domain در حوزه Crypto
...
"""domain_adapters/crypto.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تطبیق تفاوت‌های Provider با Domain در حوزه Crypto.
