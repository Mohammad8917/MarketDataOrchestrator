...
║  RESPONSIBILITY: تعریف مرز بسته Python در domain_adapters
...
"""domain_adapters/__init__.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مرز بسته Python در domain_adapters.
