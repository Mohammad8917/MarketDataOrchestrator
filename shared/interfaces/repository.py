...
║  RESPONSIBILITY: تعریف قرارداد مشترک repository
...
"""
shared/interfaces/repository.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف قرارداد مشترک repository.
