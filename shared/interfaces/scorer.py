...
║  RESPONSIBILITY: تعریف قرارداد مشترک scorer
...
"""
shared/interfaces/scorer.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف قرارداد مشترک scorer.
