...
║  RESPONSIBILITY: تعریف قرارداد مشترک validator
...
"""
shared/interfaces/validator.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف قرارداد مشترک validator.
