...
║  RESPONSIBILITY: تعریف قرارداد مشترک analyzer
...
"""
shared/interfaces/analyzer.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف قرارداد مشترک analyzer.
