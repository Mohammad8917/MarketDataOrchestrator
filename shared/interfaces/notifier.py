...
║  RESPONSIBILITY: تعریف قرارداد مشترک notifier
...
"""
shared/interfaces/notifier.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف قرارداد مشترک notifier.
