...
║  RESPONSIBILITY: تعریف قرارداد مشترک indicator
...
"""
shared/interfaces/indicator.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف قرارداد مشترک indicator.
