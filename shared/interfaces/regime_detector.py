...
║  RESPONSIBILITY: تعریف قرارداد مشترک regime_detector
...
"""
shared/interfaces/regime_detector.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف قرارداد مشترک regime_detector.
