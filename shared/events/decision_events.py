...
║  RESPONSIBILITY: تعریف رویداد مشترک decision_events
...
"""
shared/events/decision_events.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف رویداد مشترک decision_events.
