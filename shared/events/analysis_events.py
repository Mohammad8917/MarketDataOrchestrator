...
║  RESPONSIBILITY: تعریف رویداد مشترک analysis_events
...
"""
shared/events/analysis_events.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف رویداد مشترک analysis_events.
