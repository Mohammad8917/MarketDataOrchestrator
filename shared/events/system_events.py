...
║  RESPONSIBILITY: تعریف رویداد مشترک system_events
...
"""
shared/events/system_events.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف رویداد مشترک system_events.
