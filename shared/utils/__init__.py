...
║  RESPONSIBILITY: تعریف مرز بسته Python در shared/utils
...
"""
shared/utils/__init__.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مرز بسته Python در shared/utils.
