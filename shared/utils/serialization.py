...
║  RESPONSIBILITY: ارائه ابزار مشترک serialization
...
"""
shared/utils/serialization.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: ارائه ابزار مشترک serialization.
