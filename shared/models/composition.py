...
║  RESPONSIBILITY: تعریف مدل مشترک composition
...
"""
shared/models/composition.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مدل مشترک composition.
