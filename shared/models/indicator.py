...
║  RESPONSIBILITY: تعریف مدل مشترک indicator
...
"""
shared/models/indicator.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مدل مشترک indicator.
