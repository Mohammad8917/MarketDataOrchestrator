...
║  RESPONSIBILITY: تعریف مدل مشترک orderbook
...
"""
shared/models/orderbook.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مدل مشترک orderbook.
