...
║  RESPONSIBILITY: تعریف مدل مشترک market_data
...
"""
shared/models/market_data.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مدل مشترک market_data.
