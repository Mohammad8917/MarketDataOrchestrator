...
║  RESPONSIBILITY: تعریف مدل مشترک capability
...
"""
shared/models/capability.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مدل مشترک capability.
