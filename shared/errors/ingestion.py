...
║  RESPONSIBILITY: تعریف خطای مشترک ingestion
...
"""
shared/errors/ingestion.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف خطای مشترک ingestion.
