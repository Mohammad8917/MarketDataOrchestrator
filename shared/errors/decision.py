...
║  RESPONSIBILITY: تعریف خطای مشترک decision
...
"""
shared/errors/decision.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف خطای مشترک decision.
