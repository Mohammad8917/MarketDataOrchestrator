...
║  RESPONSIBILITY: تعریف خطای مشترک analysis
...
"""
shared/errors/analysis.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف خطای مشترک analysis.
