...
║  RESPONSIBILITY: تعریف مرز بسته Python در shared/errors
...
"""
shared/errors/__init__.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مرز بسته Python در shared/errors.
