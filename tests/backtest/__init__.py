...
║  RESPONSIBILITY: تعریف مرز بسته Python در tests/backtest
...
"""
tests/backtest/__init__.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مرز بسته Python در tests/backtest.
