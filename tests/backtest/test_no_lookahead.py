...
║  RESPONSIBILITY: اجرای آزمون test_no_lookahead
...
"""
tests/backtest/test_no_lookahead.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_no_lookahead.
