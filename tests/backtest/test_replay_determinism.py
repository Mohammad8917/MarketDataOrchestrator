...
║  RESPONSIBILITY: اجرای آزمون test_replay_determinism
...
"""
tests/backtest/test_replay_determinism.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_replay_determinism.
