...
║  RESPONSIBILITY: اجرای آزمون test_decision_pipeline
...
"""
tests/integration/test_decision_pipeline.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_decision_pipeline.
