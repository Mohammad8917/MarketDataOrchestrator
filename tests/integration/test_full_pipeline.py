...
║  RESPONSIBILITY: اجرای آزمون test_full_pipeline
...
"""
tests/integration/test_full_pipeline.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_full_pipeline.
