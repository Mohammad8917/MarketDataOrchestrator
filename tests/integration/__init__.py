...
║  RESPONSIBILITY: تعریف مرز بسته Python در tests/integration
...
"""
tests/integration/__init__.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مرز بسته Python در tests/integration.
