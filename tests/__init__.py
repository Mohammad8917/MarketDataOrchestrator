...
║  RESPONSIBILITY: تعریف مرز بسته Python در tests
...
"""
tests/__init__.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مرز بسته Python در tests.
