...
║  RESPONSIBILITY: تعریف مرز بسته Python در tests/unit
...
"""
tests/unit/__init__.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: تعریف مرز بسته Python در tests/unit.
