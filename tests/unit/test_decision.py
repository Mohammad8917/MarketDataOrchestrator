...
║  RESPONSIBILITY: اجرای آزمون test_decision
...
"""
tests/unit/test_decision.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_decision.
