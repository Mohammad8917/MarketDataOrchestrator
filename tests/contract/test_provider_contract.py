...
║  RESPONSIBILITY: اجرای آزمون test_provider_contract
...
"""
tests/contract/test_provider_contract.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_provider_contract.
