...
║  RESPONSIBILITY: اجرای آزمون test_no_legacy_paths
...
"""
tests/architecture/test_no_legacy_paths.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_no_legacy_paths.
