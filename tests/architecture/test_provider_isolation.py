...
║  RESPONSIBILITY: اجرای آزمون test_provider_isolation
...
"""
tests/architecture/test_provider_isolation.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_provider_isolation.
