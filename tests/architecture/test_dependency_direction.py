...
║  RESPONSIBILITY: اجرای آزمون test_dependency_direction
...
"""
tests/architecture/test_dependency_direction.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_dependency_direction.
