...
║  RESPONSIBILITY: اجرای آزمون test_forbidden_imports
...
"""
tests/architecture/test_forbidden_imports.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای آزمون test_forbidden_imports.
