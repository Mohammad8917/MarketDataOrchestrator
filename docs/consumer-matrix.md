...
| `market_data_store` (component consumer surface) | `persistence.market_data_store.MarketDataStore` | `tests/contract/test_market_data_store.py` (verification consumer only) | ACTIVE-ORPHAN — no production read consumer yet |
