...
║  RESPONSIBILITY: اجرای تحلیل تخصصی در حوزه News Sentiment
...
"""analysis/sentiment/news_sentiment.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای تحلیل تخصصی در حوزه News Sentiment.
