...
║  RESPONSIBILITY: اجرای تحلیل تخصصی در حوزه Yields
...
"""analysis/macro/yields.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای تحلیل تخصصی در حوزه Yields.
