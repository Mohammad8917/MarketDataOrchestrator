"""Implement the yields analysis responsibility at its declared analysis subsystem boundary.

FILE NAME     : analysis/macro/yields.py
KIT ADDRESS   : github.com/Mohammad8917/MarketDataOrchestrator
VERSION       : 1.0.0
DATE          : 1405/07/02 — 2026-09-24
AUTHOR        : محمد حسن زاده
RESPONSIBILITY: Implement the yields analysis responsibility at its declared analysis subsystem boundary.
