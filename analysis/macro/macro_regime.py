...
║  RESPONSIBILITY: اجرای تحلیل تخصصی در حوزه Macro Regime
...
"""analysis/macro/macro_regime.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای تحلیل تخصصی در حوزه Macro Regime.
