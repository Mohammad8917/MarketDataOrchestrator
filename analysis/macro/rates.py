...
║  RESPONSIBILITY: اجرای تحلیل تخصصی در حوزه Rates
...
"""analysis/macro/rates.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای تحلیل تخصصی در حوزه Rates.
