...
║  RESPONSIBILITY: اجرای تحلیل تخصصی در حوزه Volume Spike
...
"""analysis/volume/volume_spike.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای تحلیل تخصصی در حوزه Volume Spike.
