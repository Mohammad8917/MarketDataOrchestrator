"""
╔══════════════════════════════════════════════════════════════════════╗
║  FILE NAME     : core/concurrency.py
║  KIT ADDRESS   : github.com/Mohammad8917/MarketDataOrchestrator
║  VERSION       : 1.0.0
║  DATE          : 1405/07/02 — 2026-09-24
║  AUTHOR        : محمد حسن زاده
║  LAYER         : core
║  RESPONSIBILITY: Own the concurrency responsibility within the core layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; lower-layer orchestration contracts.
║  PYTHON        : 3.13+
