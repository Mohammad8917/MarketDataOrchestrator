...
║  RESPONSIBILITY: محاسبه امتیاز Confidence تصمیم
...
"""decision/confidence_score.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: محاسبه امتیاز Confidence تصمیم.
