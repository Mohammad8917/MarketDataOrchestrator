...
║  LAYER         : decision
║  RESPONSIBILITY: Own the confidence_calibrator responsibility within the decision layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; validated evidence/context and shared decision contracts.
║  PYTHON        : 3.13+
