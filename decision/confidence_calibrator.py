...
║  RESPONSIBILITY: کالیبراسیون Confidence
...
"""decision/confidence_calibrator.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: کالیبراسیون Confidence.
