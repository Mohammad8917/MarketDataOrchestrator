...
║  LAYER         : evidence
║  RESPONSIBILITY: Own the conflict_detector responsibility within the evidence layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; analysis/composition/strategy context and shared traceability contracts.
║  PYTHON        : 3.13+
