"""
╔══════════════════════════════════════════════════════════════════════╗
║  FILE NAME     : config/feature_flags.py
║  KIT ADDRESS   : github.com/Mohammad8917/MarketDataOrchestrator
║  VERSION       : 1.0.0
║  DATE          : 1405/07/02 — 2026-09-24
║  AUTHOR        : محمد حسن زاده
║  LAYER         : config
║  RESPONSIBILITY: Own the feature_flags responsibility within the config layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; configuration schema/infrastructure contracts.
║  PYTHON        : 3.13+
