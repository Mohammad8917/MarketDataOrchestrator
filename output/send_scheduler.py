...
║  LAYER         : output
║  RESPONSIBILITY: Own the send_scheduler responsibility within the output layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; validated signal/decision/output contracts.
║  PYTHON        : 3.13+
