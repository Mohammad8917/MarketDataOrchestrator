"""FILE: domain/crypto/context.py
KIT: Architecture & Implementation Compliance Kit
FILE_VERSION: 1.0.0
DATE_GREGORIAN: 2026-09-24
DATE_PERSIAN: 1405-07-02
AUTHOR: محمد حسن زاده
RESPONSIBILITY: Define the context domain responsibility at its declared domain boundary.
LAYER: domain
OWNS: Only the single primary responsibility declared above, including its local invariants and contract behavior.
DOES_NOT_OWN: app, core, ingestion providers, analysis, strategy, decision, risk orchestration
