...
║  LAYER         : persistence
║  RESPONSIBILITY: Own the market_data responsibility within the persistence layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; shared persistence contracts and storage abstractions.
║  PYTHON        : 3.13+
