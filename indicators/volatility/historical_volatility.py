...
║  LAYER         : indicators
║  RESPONSIBILITY: Own the historical_volatility responsibility within the indicators layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; normalized domain market data and shared contracts.
║  PYTHON        : 3.13+
