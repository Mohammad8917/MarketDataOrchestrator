...
║  RESPONSIBILITY: اجرای مسئولیت regime_performance در لایه Strategy
...
"""
strategy/evaluation/regime_performance.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت regime_performance در لایه Strategy.
