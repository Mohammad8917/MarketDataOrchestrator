...
║  RESPONSIBILITY: اجرای مسئولیت risk_metrics در لایه Strategy
...
"""
strategy/evaluation/risk_metrics.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت risk_metrics در لایه Strategy.
