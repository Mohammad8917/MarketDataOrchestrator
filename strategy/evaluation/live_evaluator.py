...
║  RESPONSIBILITY: اجرای مسئولیت live_evaluator در لایه Strategy
...
"""
strategy/evaluation/live_evaluator.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت live_evaluator در لایه Strategy.
