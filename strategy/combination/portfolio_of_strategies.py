...
║  LAYER         : strategy
║  RESPONSIBILITY: Own the portfolio_of_strategies responsibility within the strategy layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; regime/composition/domain contracts.
║  PYTHON        : 3.13+
