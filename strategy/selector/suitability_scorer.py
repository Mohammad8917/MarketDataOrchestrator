...
║  RESPONSIBILITY: اجرای مسئولیت suitability_scorer در لایه Strategy
...
"""
strategy/selector/suitability_scorer.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت suitability_scorer در لایه Strategy.
