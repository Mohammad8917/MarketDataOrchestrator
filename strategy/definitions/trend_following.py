...
║  RESPONSIBILITY: اجرای مسئولیت trend_following در لایه Strategy
...
"""
strategy/definitions/trend_following.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت trend_following در لایه Strategy.
