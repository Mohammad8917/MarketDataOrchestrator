...
║  RESPONSIBILITY: اجرای مسئولیت mean_reversion در لایه Strategy
...
"""
strategy/definitions/mean_reversion.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت mean_reversion در لایه Strategy.
