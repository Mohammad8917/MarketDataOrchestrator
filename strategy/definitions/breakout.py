...
║  RESPONSIBILITY: اجرای مسئولیت breakout در لایه Strategy
...
"""
strategy/definitions/breakout.py — Architecture Frozen v1.0 placeholder.
Primary responsibility: اجرای مسئولیت breakout در لایه Strategy.
