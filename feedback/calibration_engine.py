...
║  LAYER         : feedback
║  RESPONSIBILITY: Own the calibration_engine responsibility within the feedback layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; outcome/persistence contracts and shared performance models.
║  PYTHON        : 3.13+
