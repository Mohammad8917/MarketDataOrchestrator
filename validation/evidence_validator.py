...
║  LAYER         : validation
║  RESPONSIBILITY: Own the evidence_validator responsibility within the validation layer.
║  DEPENDENCIES  : Python 3.13+ stdlib; artifact contracts and shared validation contracts.
║  PYTHON        : 3.13+
